...
Then, we use snpEff to annotate the SNPs:

ml java/11.0.11

java -Xmx8g -jar /home/groups/dpetrov/SOFTWARE/snpEff/snpEff.jar -v -c /home/groups/dpetrov/SOFTWARE/snpEff/snpEff.config R64-1-1.99 Output/MayReSeq_Homozygous_filtered.renamedChrs.biAllelic.vcf > Output/MayReSeq_Homozygous_filtered.renamedChrs.biAllelic.ann.vcf

java -jar /home/groups/dpetrov/SOFTWARE/snpEff/SnpSift.jar extractFields Output/MayReSeq_Homozygous_filtered.renamedChrs.biAllelic.ann.vcf CHROM POS REF ALT "ANN[0].GENE" "ANN[0].EFFECT" "ANN[0].HGVS_C" "ANN[0].HGVS_P" "GEN[*].GT" > MayReSeq_Homozygous_calledSNPs.tab
